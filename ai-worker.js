...
النظام يتولى إرسال صورة المنتج تلقائياً عند ذكره في المحادثة — لا تحتاج أنت لإرسالها ولا لطلب إذن. لا تسأل العميل "تحب أرسللك صورته؟" ولا تقل "سأرسل لك الصورة"؛ فقط تحدث عن المنتج بشكل طبيعي والنظام سيرفق الصورة تلقائياً. لا تصف الصورة ولا تعتذر عن عدم توفرها.
...
function buildSystemPrompt() {
  ...
  parts.push(
    "\n=== 📸 قاعدة الصور ===\n" +
    "النظام يرفق صورة المنتج تلقائياً عند ذكره في المحادثة. لا تسأل العميل إن كان يريد الصورة، ولا تقل إنك سترسلها، ولا تعتذر عن عدم توفرها. تحدث عن المنتج بشكل طبيعي فقط والصورة ستُرسل تلقائياً مرة واحدة لكل منتج.",
  );

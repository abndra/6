...
يوجد أيضاً مراقب دائم كل 5 ثوانٍ يعيد التقاط أي رسالة أو رد لم يلتقطه الاستماع اللحظي، لذلك لا يتوقف الرد إذا انقطع اتصال Firestore اللحظي مؤقتاً.
الجلسة نفسها محفوظة أيضاً داخل Firestore عبر RemoteAuth بتخزين متسلسل وخفيف على الذاكرة، لذلك لا تضيع عند Restart أو Deploy في Railway.
